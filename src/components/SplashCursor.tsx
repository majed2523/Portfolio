...
export default function SplashCursor({
  ...
  useEffect(() => {
    ...
    function generateColor(): ColorRGB {
      // Generate only dark blue variations
      const hue = 0.6; // Blue hue (0.6 = 216 degrees = blue)
      const saturation = 0.8; // High saturation for vibrant blue
      const value = 0.3 + Math.random() * 0.4; // Dark to medium blue (0.3 to 0.7)
